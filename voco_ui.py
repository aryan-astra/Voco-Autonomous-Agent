...
class VocoApp(App):
    ...
    def _render_help(self, chat_log: RichLog) -> None:
        ...
        chat_log.write(Text("  /workspace        Show workspace info", style="#D4D4D4"))
        chat_log.write(Text("  Ctrl+G            Mock voice input", style="#D4D4D4"))
    ...
    async def on_input_submitted(self, event: Input.Submitted) -> None:
        ...
        chat_log.write(Text("[VOCO] Executing command...", style="#C96B45"))

    def action_voice_toggle(self) -> None:
        # Ctrl+G triggers voice toggle from any screen state.
        chat_log = self._activate_conversation()
